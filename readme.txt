## Notes on setting up new theme

To start with, rename your theme in style.scss.
Ensure you are using the boootstrap 5 files in the theme. 
...
Then edit your /src/ folder to update JS or SCSS.

Dont forget to make use of the colors array in `src/build/postcss.config.js` to manage your theme colors.
